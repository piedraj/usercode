...
Double_t xs8tev         [nchannels] = {999, 25.7, 22.4, 22.7, 22.8};
Double_t xs8tevErrorStat[nchannels] = {999,  1.3,  1.7,  1.5,  1.5};
Double_t xs8tevErrorSyst[nchannels] = {999,  0.0,  0.0,  0.0,  0.0};
Double_t xs8tevErrorLumi[nchannels] = {999,  1.1,  1.0,  1.0,  1.0};
